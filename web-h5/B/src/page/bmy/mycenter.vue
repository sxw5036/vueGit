						...
						<li class="mui-table-view-cell">
							<a class="mui-navigate-right">
								<div style="margin-bottom: 0.2rem; padding: 0.3rem 0;">
									...
									<p style=" float: right; margin-right: 1.5rem;font-size: 0.8rem; line-height: 1rem; margin-top: 0.3rem;">{{data.sex}}</p>
									<div class="clearfix"></div>
								</div>
							</a>
						</li>
						<li class="mui-table-view-cell">
							<a class="mui-navigate-right">
								<div style="margin-bottom: 0.2rem;padding: 0.3rem 0;">
									...
									<p style=" float: right; margin-right: 1.5rem;font-size: 0.8rem; line-height: 1rem; margin-top: 0.3rem;">{{data.birthday}}</p>
									<div class="clearfix"></div>
								</div>
							</a>
						</li>
						<li class="mui-table-view-cell">
							<a class="mui-navigate-right">
								<div style="margin-bottom: 0.2rem; padding: 0.3rem 0;">
									...
									<p style=" float: right; margin-right: 1.5rem;font-size: 0.8rem; line-height: 1rem; margin-top: 0.3rem;">{{data.education}}</p>
									<div class="clearfix"></div>
								</div>
							</a>
						</li>

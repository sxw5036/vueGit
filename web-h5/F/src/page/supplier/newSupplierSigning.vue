			...
			<ul>
				...
				<li @click="addsiteshow=!addsiteshow" class="dwbb">
					<span>地区:</span><input  readonly="readonly" type="tel" style="z-index: 1;  " v-model="searchObj.mergerShortName" placeholder="请选择" /><span
					 class="dw"><img src="../../assets/img/finance/xljt.png" style="width: 0.5rem; margin-top: 0.5rem;margin-right: 0.85rem; "  /></span>
				</li>
				<!-- <li>
...
<style scoped="scoped">
	...
	.spanselect1> .select1 {
		...
		background: url(../../assets/img/finance/xljt.png) 10.5rem center no-repeat;

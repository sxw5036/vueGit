				   ...
				   <div class="after_inputs">
					   ...
					   <div style="margin-bottom: 0.5rem; margin-top: 0.5rem;">
					  						  ...
					  						  <div style="float: left;width: 48%; color:#a4a4a4; height: 2rem; border-radius: 0.25rem;border: 1px solid #dcdee2; box-sizing: border-box; position: relative;">
					  							  ...
					  							  <span style="position:absolute;top:0.3rem;left:80%;"><img style="width: 0.7rem;" src="../../assets/img/dealer/left_ar.png"/></span>
					  						   </div>
					  						   <div class="clearfix"></div>
					  </div>
				   </div>
	...
	export default {
		...
		methods: {
			...
			shouhou:function  () {
				...
				this.$router.push({ name: 'shouhou'});
				
			},
		    
			 changePath:function  (aftersaleId) {
			 	
			 	this.$router.push({ name: 'afterdepmore', query: { aftersaleId:aftersaleId }})

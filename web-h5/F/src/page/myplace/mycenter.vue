	    ...
	    <div style="padding:0 0.5rem; margin-top: 0.5rem;">
	   		   <div style="background-color: white; border-radius:0.25rem; padding:0.5rem 0">
	   			  <ul class="mui-table-view">
						...
						<li class="mui-table-view-cell"  @click="birthday(mycenter.birthday.substring(0,10))">
							<a class="mui-navigate-right">
								<div style="margin-bottom: 0.2rem;padding: 0.3rem 0;">
									...
									<p style=" float: right; margin-right: 1.5rem;font-size: 0.8rem; line-height: 1rem; margin-top: 0.3rem;">{{mycenter.birthday.substring(0,10)}}</p>
									<div class="clearfix"></div>
								</div>
							</a>
						</li>
	   						...
	   						<li class="mui-table-view-cell">
	   							<a class="mui-navigate-right">
	   								<div style="margin-bottom: 0.2rem;padding: 0.3rem 0;">
	   									...
	   									<p style=" float: right; margin-right: 1.5rem;font-size: 0.8rem; line-height: 1rem; margin-top: 0.3rem;">{{mycenter.created.substring(0,10)}}</p>
	   									<div class="clearfix"></div>
	   								</div>
	   							</a>
	   						</li>
...
<script>
	...
	export default {
		...
		methods: {
			...
			birthday(birthday){
				this.$router.push({ name: 'birthday', query: { birthday:birthday}})
			 },
			 education(education){
				this.$router.push({ name: 'education', query: { education:education }})
			 },
			  sexchanges(sex){
				   this.$router.push({ name: 'sexchanges', query: { sex:sex }})
			   },
			   identiy(identityNumber){
				   this.$router.push({ name: 'changes', query: { identityNumber:identityNumber }})
			   },

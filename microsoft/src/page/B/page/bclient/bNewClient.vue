		...
		<div class="clienttop">
			<ul>
				...
				<li @click="addsiteshow=!addsiteshow">
					<span class="wenzi">地区:</span><span class="ipt1"><input readonly="readonly" type="text" placeholder="请选择您的地区" v-model="searchObj.mergerShortName" />
					</span>
				</li>
				<li>

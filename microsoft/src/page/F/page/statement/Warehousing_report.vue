<template>
	<div id="ruku">
		<header class="mui-bar mui-bar-nav " data-top='0' data-offset='150' data-duration='16' data-scrollby=".mui-scroll-wrapper">
			...
			<h1 class="mui-title">入库报表</h1>
		</header>
		<div style="width: 100%; height: 2.1rem;">
		
		</div>
		<div class="rukuTop" style="text-align: center; margin:0.75rem 0;">
		...
		<div class="rukuCenter" style="padding-top: 1.025rem;">
			
			<div class="rukudateleft" style="position: relative; width:7.325rem;float: left; margin-left: 0.65rem;margin-bottom: 0.68rem; ">
			...
			<div class="rukudateright" style="position: relative; width:7.325rem; float: left; margin-left: 1.8rem;margin-bottom: 0.68rem; ">
		...
		<div class="rukuBottom">
			<div class="rukuBottomTabBar">
				<ul class="rukutabBar-tilte">
				    <li @click="rukuchoose0()"  style="margin-left: 1.5rem;" ><span :class="{active:rukuchoose==0}">新增</span></li>
				    <li @click="rukuchoose1()" ><span :class="{active:rukuchoose==1}">库存</span></li>
				...
				<div class="keepContent">
					<div class="keepContentShow" id="financeSS" style="  position:relative  ; width: 95%; margin: 0 auto; height: auto; background-color: white; border-radius: 0.25rem;">
						<div class="SStop" id="SStopWarehousing_report" style="  background-color: white; height:11.925rem; width: 95%; margin: 0.1rem auto; ">
				
				
						</div>
					<!-- 	<div v-show="rukuchoose==0 " class="SStopText" style="position: absolute; left: 1.5rem; bottom: 0.7rem;">
						...
						<div v-show="rukuchoose==1 " class="SStopText" style=" padding-bottom: 0.5rem; padding-left: 1.5rem; border-radius: 0.25rem; position: absolute; left: 0rem; bottom: 0.2rem;background-color: white; width: 100%;">
								<p><span style="display: inline-block; width: 8.6rem; color: #000000;">1.全国新增设计单：<span>29</span>&nbsp;件</span></p>
							<p><span style="display: inline-block; width: 8.6rem; color: #000000;">2.环比减少：<span>2</span>&nbsp;件</span></p>
					...
					<!-- <div v-show="rukuchoose==2" style="height: 2rem; width: 100%;">
				
					</div>
					<div v-show="rukuchoose==3" style="height: 1rem; width: 100%;">
					...
					<div class="keepContentShow1" style=" position: relative; height: 15.5rem; width: 95%; margin: 1rem auto; padding-top: 1rem;  background: white; border-radius: 0.25rem;">
						<div class="show1YB" id="show1Warehousing_report" style="height: 15.5rem; width: 95%; margin: 0 auto;">
				
						</div>
					<!-- 	<div  v-show="rukuchoose==0" class="show1YBtext" style=" position: absolute; left: 20%; bottom: 10%; font-size: 0.6rem; ">
						...
						<div  v-show="rukuchoose==1"  class="show1YBtext" style=" position: absolute; left: 20%; bottom: 5%; font-size: 0.6rem; ">
						...
						<div  v-show="rukuchoose==2" class="show1YBtext" style=" position: absolute; left: 20%; bottom: 5%; font-size: 0.6rem; ">
						...
						<div style="position: absolute; top: 5.5%; left: 50%; margin-left: -1.875rem;">
							<span v-show="rukuchoose==0" style="font-weight: 500; color: #000000; font-size: 0.75rem;">新增分布</span>
							<span v-show="rukuchoose==1" style="font-weight: 500; color: #000000; font-size: 0.75rem;">库存分布</span>
		...
		methods: {
			thisweek() {
				...
				that.axios({
					...
					url: '/wxapi/f/finishStockStatements/week/' + that.rukuchoose
			...
			thismonth() {
				...
				that.axios({
					...
					url: '/wxapi/f/finishStockStatements/month/' + that.rukuchoose
			...
			thisseason() {
				...
				that.axios({
					...
					url: '/wxapi/f/finishStockStatements/quarter/' + that.rukuchoose
			...
			thisyear() {
				...
				that.axios({
					...
					url: '/wxapi/f/finishStockStatements/year/' + that.rukuchoose
			...
			searchdata(){
				...
				that.axios({
					method:'get',
					url:'/wxapi/f/finishStockStatements/'+that.rukuchoose+'?'+ (that.searchObj.startTime == '' ? '' : 'startTime=' + that.searchObj.startTime)+(that.searchObj.endTime == '' ? '' : '&endTime=' + that.searchObj.endTime)
				}).then(function(res) {
				...
				if (this.week == 1) {
					...
					// }
					var myChart = echarts.init(document.getElementById('SStopWarehousing_report'));
					myChart.setOption({
						title: {
					...
					var myChart1 = echarts.init(document.getElementById('show1Warehousing_report'));
					myChart1.setOption({

<template>
	...
	<div class="mui-scroll">
	   		  ...
	   		  <div class="after_js">
	   		  				   ...
	   		  				   <div class="after_inputs">
	   		  					   ...
	   		  					   <div class="intent_select">
	   		  						   ...
	   		  						   <img class="intent_icon" style="width: 0.5rem; margin-left: 1.7rem;" src="../../assets/img/dealer/left_ar.png"/>
	   		  					   </div>
	   ...
	   <Address :show="addsiteshow" @sure='surreAddress' @cancel="addsiteshow=!addsiteshow"></Address>
		<div class="newjxs1" style="z-index: 9; ">
	...
	export default {
		...
		methods: {
			...
			newsdealer:function  () {
				...
				this.$router.push({ name: 'FnewDealers'})
			...
			changePath:function  (id) {
				...
				this.$router.push({ name: 'Fdealerdep', query: { id:id }})

<template>
	...
	<h1 class="mui-title">标题</h1>
									...
									<ul>
										...
										<li class="linkBlock" style="height: 2rem;">
											<div class="linkBlock_item select" style="height: 1rem;">
												...
												<span class="select_icon"><img src="../../assets/img/finance/xljt.png" style="width: 0.5rem; margin-top: 0.1rem;" /></span>
											</div>
											<div class="linkBlock_item select">
		...
		<div class="finance_but" style="z-index: 9;">
			<ul>
				<li>
					<router-link :to="{name:'Fnewfinance',query:{type:'2'}}"><img src="../../assets/img/finance/newExpend.png" />新建支出</router-link>
				</li>
				<li>
					<router-link :to="{name:'Fnewfinance',query:{type:'1'}}"><img src="../../assets/img/finance/newIncome.png" />新建收入</router-link>
				</li>
			</ul>
		</div>
		<!-- <div id="backtop ">
			<span class="backtop">
				<img @click="scrollTop()" src="../../assets/img/back-top.png" />
			</span>
		</div> -->
		<!-- <Backtop></Backtop> -->

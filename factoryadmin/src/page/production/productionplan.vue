	...
	<div class="contain">
		<div class="Breadcrumb">
			<Breadcrumb>
				...
				<BreadcrumbItem>生产跟进管理</BreadcrumbItem>
			</Breadcrumb>
			<Row>
				<Col span="20" style="margin-bottom: 20px;margin-top: 20px;">
				<div>
					生产单编号：<Input v-model="ordernum" placeholder="请输入生产单编号..." style="width: 16%;margin:0 5px;"></Input>
				<!-- 	客户名称：<Input v-model="customname" placeholder="请输入客户名称..." style="width: 16%;margin:0 5px;"></Input> -->
					<Button @click="serchorder" icon="ios-search">搜索</Button>
				</div>
				</Col>

				<Col span="4" style="margin-bottom: 20px;margin-top: 20px; text-align: right;">
				<Button type="primary" @click="buildplans">创建计划</Button>
				</Col>
			</Row>
			<Col style=" margin-bottom: 30px;">
			<Table :columns="columns1" :data="data1" border></Table>
			</Col>
			<div class="fenye_produce_plan" style="margin-top: -20px;">
			...
			<div>
				<Row span="24" style="padding:10px;">
					...
					<div style=" margin-left: 20px; margin-bottom: 20px;">
						计划生产时间：<DatePicker type="date"  v-model="plansTime" placeholder="请选择计划生产时间" style="width: 25%; margin-right: 10px;" :value="plansTime" @on-change="handleChanges"></DatePicker>
					    生产线安排：<Select v-model="orderproducts" style="width: 25%; margin: 5px;">

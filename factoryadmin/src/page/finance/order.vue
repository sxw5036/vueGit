...
//					}
		...
		methods: {
			...
			newOpen:function  () {
				this.$emit('openWindow', ('financeorderNewly'), ('新建财务收支'), ('3-1'), ('financeorderNewly'), ('financeorderNewly'))
			},
			...
			getDatas: function() {
				...
				this.axios({
					method: 'get',
					url: '/api/f/finances/customorders?pageNum=' + this.pageIndex + '&pageSize=' + this.pageSize,

	...
	<div>
		<div class="Breadcrumb">
			...
			<Breadcrumb >
				...
				<BreadcrumbItem>设计任务管理</BreadcrumbItem>
			</Breadcrumb>
		</div>
		...
		<div >
			<Row>
				...
				<div class="panel">
					<div class="panel_nav">
						<div class="panel_center">
							<h3 class="head">设计任务总数</h3>
							<div class="panel_con">

								<div class="head-statement-1">
									<p>{{pageIndextotal}}</p>
									<img src="../../assets/img/supplier/01.png" />
								</div>
				...
				<div class="panel">
					<div class="panel_nav">
						<div class="panel_center">
							<h3 class="head">今日新增设计</h3>
							<div class="panel_con">
								<div class="head-statement-2">
									<p>5个</p>
									<img src="../../assets/img/supplier/02.png" />
								</div>
							</div>
				...
				<div class="panel">
					<div class="panel_nav">
						<div class="panel_center">
							<h3 class="head">设计增长率</h3>
							<div class="panel_con">
								<div class="head-statement-3">

									<img src="../../assets/img/supplier/03.png" />
									<p>55%</p>
								</div>
							</div>
		...
		<div class="operation_box">
			<div class="active">
				...
				<div class="ui_operateLeft" style="line-height: 32px;">
					...
					<span class="operation_span">客户手机号：</span>
